...
<div class="m-content">
	<div class="m-portlet m-portlet--mobile">
		...
		<!--begin::Form-->
		{!! Form::model($lotteryEdition, ['route' => ['lotteryEditionTickets.addUser.store', $lotteryEdition], 'enctype' => 'multipart/form-data', 'class' => 'm-form']) !!}
			@include('admin.lotteryEditions.tickets.form', $lotteryEdition)
		{!! Form::close() !!}
		<!--end::Form-->
	</div>
</div>
