    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                ...
                @if(auth()->user()->isAdmin() || auth()->user()->isStock())
                    <div class="m-portlet__head-tools">
                        <a href="{{route('drawLottery.reportAll')}}" class="btn btn-default m--margin-left-10">
                            Отчет
                        </a>
                        <a href="{{route('drawLottery.create')}}" class="btn btn-info m--margin-left-10">
                            Добавить
                        </a>
                    </div>
                @endif
            ...
            <div class="m-portlet__body">
                ...
                <!--end: Search Form -->
                <!--begin: Datatable -->
                <div class="m_datatable" id="drawLotteries"></div>
                <!--end: Datatable -->
            </div>
        </div>
...
@section('footer')
    {{--<script src="{{asset('assets/admin/js/dataTable/lottery.js')}}" type="text/javascript"></script>--}}
    <script src="{{asset('assets/admin/js/dataTable/drawLotteries.js')}}" type="text/javascript"></script>
